...
public class SkyBerrySeed extends Item implements IPlantable {
	
	private Block plant;
	private String name = "SkyBerrySeed";
	
	public SkyBerrySeed(Block plant)
	{
		this.plant = plant;
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		{
			if (par3World.getBlock(par4, par5, par6) == Blocks.grass || par3World.getBlock(par4, par5, par6) == Blocks.dirt)
			{
